...
<title>商品列表 - 库存管理 - 找靓机后台管理系统 v3.0</title>
</head>
<body>
<!--_header 作为公共模版分离出去-->
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"><a href="javascript:;" onclick="member_add('添加商品','reserve-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加库存</a></span> <span class="r">共有数据：<strong>60</strong> 条</span> </div>
			<div class="mt-20">
