...
Date: 2019-12-26 17:55:12
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for activity_discount
-- ----------------------------
DROP TABLE IF EXISTS `activity_discount`;
CREATE TABLE `activity_discount` (
  `activity_discount_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '打折活动详情id(主键)',
  `activity_name` varchar(255) NOT NULL COMMENT '活动名称',
  `activity_type` int(11) NOT NULL COMMENT '活动类型id(外键)',
  `activity_discount` int(11) NOT NULL COMMENT '折扣',
  `start_time` varchar(255) NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(255) NOT NULL COMMENT '活动结束时间',
  `delete_flag` int(1) NOT NULL DEFAULT '0' COMMENT '删除标记(0代表存在,1代表被删除)',
  PRIMARY KEY (`activity_discount_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='打折活动';

-- ----------------------------
-- Table structure for activity_discount_product
-- ----------------------------
DROP TABLE IF EXISTS `activity_discount_product`;
CREATE TABLE `activity_discount_product` (
  `produc_id` int(11) NOT NULL COMMENT '商品的id(外键)',
  `activity_discount_id` int(11) NOT NULL COMMENT '打折活动详情id(外键)'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='打折活动详情';

-- ----------------------------
-- Table structure for activity_reduce
-- ----------------------------
DROP TABLE IF EXISTS `activity_reduce`;
CREATE TABLE `activity_reduce` (
  `activity_reduce_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '满减活动详情id(主键)',
  `activity_name` varchar(255) NOT NULL COMMENT '活动名称',
  `activity_type` int(255) NOT NULL COMMENT '活动类型id(外键)',
  `full_money` int(255) NOT NULL COMMENT '满的金额',
  `reduce_money` int(255) NOT NULL COMMENT '减的金额',
  `delete_flag` int(11) NOT NULL COMMENT '活动商品结束标记(1代表被删除,0代表未删除)',
  `start_time` varchar(255) NOT NULL COMMENT '活动开始时间',
  `end_time` varchar(255) NOT NULL COMMENT '活动结束时间',
  PRIMARY KEY (`activity_reduce_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='满减活动';

-- ----------------------------
-- Table structure for activity_reduce_product
-- ----------------------------
DROP TABLE IF EXISTS `activity_reduce_product`;
CREATE TABLE `activity_reduce_product` (
  `produc_id` int(11) NOT NULL COMMENT '商品的id(外键)',
  `activity_reduce_id` int(11) NOT NULL COMMENT '满减活动详情id(外键)'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='满减活动详情';
...
CREATE TABLE `activity_type` (
  `activity_type_id` int(255) NOT NULL AUTO_INCREMENT COMMENT '活动类型id(主键)',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='活动类型表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='商品品牌';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='商品品牌颜色';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='商品型号';
...
CREATE TABLE `order_table` (
  ...
  `actual_amount` decimal(65,0) NOT NULL COMMENT '实际金额',
  `activity_amount` decimal(65,0) DEFAULT NULL COMMENT '活动后的金额',
  `order_time` varchar(255) NOT NULL COMMENT '订单下单时间',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
...
CREATE TABLE `shop_cart` (
  ...
  `person_id` int(11) NOT NULL COMMENT '用户的id(外键)',
  `product_id` int(11) NOT NULL COMMENT '商品id(外键)',
  `product_color` int(11) NOT NULL COMMENT '商品颜色',
  `product_standard` int(11) NOT NULL COMMENT '商品规格',
